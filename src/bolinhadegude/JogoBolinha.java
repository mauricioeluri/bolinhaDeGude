...
abstract class JogoBolinha {
    ...
    private final ArrayList<Integer> bolinhas = new ArrayList<>();
    private final ArrayList<Integer> consultas = new ArrayList<>();
    private final ArrayList<int[]> resultados = new ArrayList<>();
    ...
    /**
     * Método com verificações para validar que o valor inserido está entre 0 e
     * 10000. Caso retorne positivo, retorna o próprio valor, caso negativo,
    ...
    /**
     * Método para retornar os resultaos formataos de maneira textual, utilizado
     * para o processamento do jogo em formato textual.
     *
